...
# 12 "./ECUAL/EXT_EEPROM_24C02C/ext_eeprom_24c02c.h"
...
# 14 "./ECUAL/RTC_DS1307/rtc_ds1307.h"
typedef struct{
    uint8_t _day;
    uint8_t _month;
    uint8_t _year;
...
# 14 "./ECUAL/TempSensor_TC47/tempsensor_tc47.h"
...
# 76 "main.c"
    ...
    EXT_EEPROM_24C02C_write(0x51,0x00,Temp_Set_Value);



    while (1)
    {
        RTC_DS1307_print(0x68);
        TempSensor_Val = TEMPSENSOR_TC47_Read(0x4F);
        Temp_Set_Value = EXT_EEPROM_24C02C_read(0x51,0x00);
        if(TempSensor_Val >Temp_Set_Value){
            I2C_Write1ByteRegister(0x60,0x00,'o');

        }
        else{
            I2C_Write1ByteRegister(0x60,0x00,'c');
        }
